...
type Unnamed_4_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'lang' | 'locale'>> }>, readonly wp: Maybe<{ readonly generalSettings: Maybe<Pick<WpGeneralSettings, 'title' | 'description' | 'language'>> }> };
